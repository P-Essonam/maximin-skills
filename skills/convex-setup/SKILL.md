...
Reference: [Convex TanStack Start quickstart](https://docs.convex.dev/quickstart/tanstack-start). Use its steps 2 through 5 with the monorepo adaptations below.
